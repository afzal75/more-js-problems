function animelCount (miles) {
    ...
    if (miles <= 10) {
        ...
        const RestDenseAnimels = restMiles * animalDensityRestMiles;
        const totalAnimals = firstDenseAnimals + secondDenseAnimals + RestDenseAnimels;
        return totalAnimals;
    }
}


const animals =  animelCount (25);
console.log(animals);
